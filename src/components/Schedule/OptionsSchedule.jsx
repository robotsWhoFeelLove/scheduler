...
function OptionsSchedule({ setter }) {
  return (
    <div className="flex w-screen justify-end gap-2 items-center m-2">
      <div className="btn btn-sm btn-outline text-white bg-[#00b3f0]" onClick={() => setter("poster")}>
        Get Poster
      </div>
      <div className="mt-1 cursor-pointer" onClick={() => shareSchedule(window.location.href)}>
