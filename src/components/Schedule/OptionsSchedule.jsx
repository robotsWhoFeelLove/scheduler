  ...
  return (
    <>
      ...
      <div className="flex  justify-end gap-8 items-center m-2">
        ...
        {tourIndex == 3 && (
          <div className="-mt-6 mr-8 z-50 pinhole w-[100px] h-[100px] rounded-full animate-fade-up animate-once animate-duration-[800ms] animate-ease-linear">
            <div onClick={() => handleTour()} className=" z-50  w-[130px] h-[130px] rounded-full "></div>
          </div>
        )}
        <PosterIcon setter={setter} />
        {tourIndex == 2 && (
          <div className="-mt-6 -mr-7 z-50 pinhole w-[100px] h-[100px] rounded-full animate-fade-up animate-once animate-duration-[800ms] animate-ease-linear">
            <div onClick={() => handleTour()} className=" z-50  w-[130px] h-[130px] rounded-full "></div>
          </div>
        )}
        <ShareIcon />
